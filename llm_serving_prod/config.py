...
api_key = 'sk-86b3f17f889f439b91886411d12fa21a'
llm_model_name = 'qwen-plus'
dashscope_url = 'https://prem.dashscope.aliyuncs.com/api/v1'
...
device_type = ['筒灯','射灯','灯带','格栅灯','吊线灯','线条灯','轨道.*?灯','智能.*?灯','开关','轨道','空调','内机','AC','新风']
